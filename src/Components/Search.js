...
const styles = {
  ...
  button: {
    ...
    '&:hover': { // Trying to add hover effect to the button but not working right now.
      backgroundColor: '#fffff', // Change the background color on hover
    },
  },
...
// This code defines a React functional component named Search using several useState hooks to manage its state:

// eventTitle, category, registrationsAllowed: Strings to store the title of an event, its category, and registration status.
// isActive, isFinished: Booleans to track whether the event is active or finished.
// searchResults: An array to store search results.
// Each state has a setter function (e.g., setEventTitle) to update its value. The initial states are empty strings for text values, false for boolean values, and an empty array for search results.
const Search = () => {  
  ...
  const handleSearch = () => {
    ...
    (yearFilter === '' || event.details.toLowerCase().includes(yearFilter))
  );
  ...
  return (
    <div style={styles.mainContainer}>
      <div style={styles.searchContainer}>
        ...
        <label style={styles.label}>Search by Year:</label>
        <input
          style={styles.input}
          type="text"
          value={yearFilter}
...
<div style={styles.checkboxContainer}>
  ...
  <h2 style={{ marginRight: '55px' }}>Search Results:</h2>
